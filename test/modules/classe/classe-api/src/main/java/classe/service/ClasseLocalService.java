...
public interface ClasseLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>classe.service.impl.ClasseLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the classe local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ClasseLocalServiceUtil} if injection and service tracking are not available.
	 */
