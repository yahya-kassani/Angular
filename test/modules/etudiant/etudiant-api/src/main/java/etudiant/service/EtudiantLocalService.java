...
/**
 * Provides the local service interface for Etudiant. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EtudiantLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EtudiantLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>etudiant.service.impl.EtudiantLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the etudiant local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EtudiantLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Etudiant createEtudiant(long etudiantId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Etudiant deleteEtudiant(long etudiantId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Etudiant fetchEtudiant(long etudiantId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Etudiant getEtudiant(long etudiantId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Etudiant> getEtudiants(int start, int end);
