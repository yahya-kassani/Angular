...
/**
 * Provides the local service interface for Professeur. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProfesseurLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ProfesseurLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>professeur.service.impl.ProfesseurLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the professeur local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ProfesseurLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Professeur update(long professeurId, String nom, String prenom)
		throws PortalException;
