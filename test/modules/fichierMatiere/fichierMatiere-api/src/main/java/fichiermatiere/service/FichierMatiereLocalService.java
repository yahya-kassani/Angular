...
/**
 * Provides the local service interface for FichierMatiere. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FichierMatiereLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FichierMatiereLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>fichiermatiere.service.impl.FichierMatiereLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the fichier matiere local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FichierMatiereLocalServiceUtil} if injection and service tracking are not available.
	 */
